export const tools = [
    ...
    },
    {
        ...
        class: "move-tool",
        title: "Move",
        icon: `<svg width="18" height="18" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            fill="currentColor"
    ...
    },
    {
        ...
        class: "undo-tool",
        title: "Undo",
        icon: ` <svg height="18" id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1"
        ...
        onClick: (editor) => {
            ...
            editor.drawLineTool.highlightCircle = null;
            if (!editor.undoRedoManager.canRedo()) {
                editor.toolbar.container.querySelector("#redo-tool").disabled = true;
            } else {
                editor.toolbar.container.querySelector("#redo-tool").disabled = false;
            }

            if (!editor.undoRedoManager.canUndo()) {
                editor.instructionText.classList.remove("hidden");
                editor.toolbar.container.querySelector("#undo-tool").disabled = true;
            } else {
                editor.toolbar.container.querySelector("#undo-tool").disabled = false;
            }
        },
    },
    {
    ...
    {
        id: "clear-all-tool",
        class: "clear-all-tool",
        title: "Clear all",
        icon: `<svg enable-background="new 0 0 48 48" height="18" version="1.1" viewBox="0 0 48 48" width="18"
        ...
        onClick: (editor) => {
            editor.clearCanvas();
            editor.undoRedoManager.captureInitialState();
        },
    },
    {
        id: "save-tool",
        ...
        onClick: (editor) => {
            const graphData = editor.getGraph();
